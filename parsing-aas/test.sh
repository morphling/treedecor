...
for i in {1..100}
do
	curl -X GET -H 'Content-Type: application/binary' -d @../renderer.imp/plugin.xml "http://$HOST/parse/xml-1654052769?disableSourceLocationInformation=true&prettyPrint=true"
done
